...
class SubtitlesDownloader:
    ...
    converted_dir: str = attr.ib(init=False)
    ...
    def download_subtitles(self, url: str) -> Generator[str, None, None]:
        ...
        for path in Path(self.output_dir).iterdir():
            ...
            if ext in CONVERTERS_REGISTRY:  # convert subtitles and return a new filename
                ...
                converted_filename = converter(output_dir=self.converted_dir).convert(str(path))
